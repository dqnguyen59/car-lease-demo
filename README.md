...
Run three user-service instances with different port numbers:
...
Run three car-service instances with different port numbers:
...
Run three customer-service instances with different port numbers:
