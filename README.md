...
Run three user-service instances with different port numbers each:
...
Run three car-service instances with different port numbers each:
...
Run three customer-service instances with different port numbers each:
